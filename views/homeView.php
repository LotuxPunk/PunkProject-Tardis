...
<li class="nav-item"><a class="nav-link" href="index.php?p=request">All requests</a></li>
...
<div class="bg-white rounded mb-3 request">
    ...
    while($row = $request->fetch_assoc()){
        ...
        echo '<div class="border-bottom row"><div class="col-9"><h5>'.$row['title'].'<small> by '.$row['username'].'</small></h5><p>'.htmlspecialchars_decode($row['content']).'</p></div><div class="col-3">'.$vote.'</div></div>';
    } ?>
</div>
